...
exports.ANALYSIS_SKILL_CATALOG = void 0;
exports.analysisSkillCatalogArtifact = analysisSkillCatalogArtifact;
exports.analysisSkillIds = analysisSkillIds;
exports.ANALYSIS_SKILL_CATALOG = [
    {
...
function analysisSkillCatalogArtifact() {
    return {
        ...
        skills: exports.ANALYSIS_SKILL_CATALOG
    };
}
function analysisSkillIds() {
    return exports.ANALYSIS_SKILL_CATALOG.map(skill => skill.id);
}
