...
exports.REPORT_COMPONENT_LIBRARY = void 0;
exports.supportedReportComponentTypes = supportedReportComponentTypes;
exports.reportComponentLibraryArtifact = reportComponentLibraryArtifact;
exports.REPORT_COMPONENT_LIBRARY = [
    {
        id: 'narrative',
        label: 'Narrative',
...
function supportedReportComponentTypes() {
    return exports.REPORT_COMPONENT_LIBRARY.map(component => component.id);
}
function reportComponentLibraryArtifact() {
    return {
        ...
        components: exports.REPORT_COMPONENT_LIBRARY
    };
}
