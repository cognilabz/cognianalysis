...
function writeLlmTasks(analysisDir, codeMap) {
    ...
    (0, utils_1.writeJson)(utils_2.Path.join(analysisDir, 'task-manifest.json'), { mode: 'llm_first', implementation_language: 'TypeScript', pipeline, source_tier_tasks: tierManifest.tasks, tasks: taskDefs });
    return taskDefs;
}
