...
[
  ...
  {
    "type": "validation_or_business_rule_hint",
    "label": "risk, decides the customer status, stores the customer and publishes an event.\",",
    "path": ".analysis-seed/llm/business-domain-logic.json",
    "line": 200,
    "confidence": "hint"
  },
  ...
  {
    "type": "external_call_hint",
    "label": "call or persistence happens.\",",
    "path": ".analysis-seed/llm/business-domain-logic.json",
    "line": 218,
    "confidence": "hint"
  },
  ...
  {
    "type": "ui_route_hint",
    "label": "path\": \"src/main/java/com/acme/onboarding/DuplicateCustomerException.java\",",
    "path": ".analysis-seed/llm/business-domain-logic.json",
    "line": 226,
    "confidence": "hint"
  },
  {
    "type": "validation_or_business_rule_hint",
    "label": "risk score above 70 moves the customer to manual review.\",",
    "path": ".analysis-seed/llm/business-domain-logic.json",
    "line": 232,
    "confidence": "hint"
  },
  ...
  {
    "type": "validation_or_business_rule_hint",
    "label": "risk score at or below 70 activates the customer.\",",
    "path": ".analysis-seed/llm/business-domain-logic.json",
    "line": 246,
    "confidence": "hint"
  }
...
onboarding, customer, status, verify, acme, identity, result, start, analysis, seed, json, service, event, started, docs, wsdl, exception, resources, reference, review, repository, examples, openapi, approved, input, output, business, found, duplicate, client, controller, publisher, risk, scoring, flows, verification, soap, pending, mark, manual, activate, reason, onboard, publish, calculate, score, yaml, birth, date, architecture, refactoring, roadmap, domain, logic, core, assessment, data, integrations, documentation, goal, coverage, interfaces, process, quality, readiness, readme, application
